...
begin  -- architecture behavioral
    ...
    if rising_edge(clk) then  -- rising clock edge
      ...
      if wb_strobe='1' then
        ...
        when 18 => --0x12
          ...
          localRdData(18 downto 16)  <=  reg_data(18)(18 downto 16);                  --
          localRdData(22 downto 20)  <=  reg_data(18)(22 downto 20);                  --
          localRdData(26 downto 24)  <=  reg_data(18)(26 downto 24);                  --
          localRdData(30 downto 28)  <=  reg_data(18)(30 downto 28);                  --
        when 19 => --0x13
          localRdData( 2 downto  0)  <=  reg_data(19)( 2 downto  0);                  --
          localRdData( 6 downto  4)  <=  reg_data(19)( 6 downto  4);                  --
          localRdData(10 downto  8)  <=  reg_data(19)(10 downto  8);                  --
          localRdData(14 downto 12)  <=  reg_data(19)(14 downto 12);                  --
          localRdData(18 downto 16)  <=  reg_data(19)(18 downto 16);                  --
          localRdData(22 downto 20)  <=  reg_data(19)(22 downto 20);                  --
          localRdData(26 downto 24)  <=  reg_data(19)(26 downto 24);                  --
          localRdData(30 downto 28)  <=  reg_data(19)(30 downto 28);                  --
        when 20 => --0x14
          localRdData( 2 downto  0)  <=  reg_data(20)( 2 downto  0);                  --
          localRdData( 6 downto  4)  <=  reg_data(20)( 6 downto  4);                  --
          localRdData(10 downto  8)  <=  reg_data(20)(10 downto  8);                  --
          localRdData(14 downto 12)  <=  reg_data(20)(14 downto 12);                  --
          localRdData(18 downto 16)  <=  reg_data(20)(18 downto 16);                  --
          localRdData(22 downto 20)  <=  reg_data(20)(22 downto 20);                  --
          localRdData(26 downto 24)  <=  reg_data(20)(26 downto 24);                  --
          localRdData(30 downto 28)  <=  reg_data(20)(30 downto 28);                  --
        when 21 => --0x15
          localRdData( 2 downto  0)  <=  reg_data(21)( 2 downto  0);                  --
          localRdData( 6 downto  4)  <=  reg_data(21)( 6 downto  4);                  --
  ...
  Ctrl.LPGBT.UPLINK(0).ALIGN_0                 <=  reg_data( 2)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_1                 <=  reg_data( 2)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_2                 <=  reg_data( 2)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_3                 <=  reg_data( 2)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_4                 <=  reg_data( 2)(18 downto 16);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_5                 <=  reg_data( 2)(22 downto 20);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_6                 <=  reg_data( 2)(26 downto 24);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_7                 <=  reg_data( 2)(30 downto 28);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_8                 <=  reg_data( 3)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_9                 <=  reg_data( 3)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_10                <=  reg_data( 3)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_11                <=  reg_data( 3)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_12                <=  reg_data( 3)(18 downto 16);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_13                <=  reg_data( 3)(22 downto 20);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_14                <=  reg_data( 3)(26 downto 24);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_15                <=  reg_data( 3)(30 downto 28);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_16                <=  reg_data( 4)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_17                <=  reg_data( 4)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_18                <=  reg_data( 4)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_19                <=  reg_data( 4)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_20                <=  reg_data( 4)(18 downto 16);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_21                <=  reg_data( 4)(22 downto 20);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_22                <=  reg_data( 4)(26 downto 24);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_23                <=  reg_data( 4)(30 downto 28);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_24                <=  reg_data( 5)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_25                <=  reg_data( 5)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_26                <=  reg_data( 5)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(0).ALIGN_27                <=  reg_data( 5)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_0                 <=  reg_data(18)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_1                 <=  reg_data(18)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_2                 <=  reg_data(18)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_3                 <=  reg_data(18)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_4                 <=  reg_data(18)(18 downto 16);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_5                 <=  reg_data(18)(22 downto 20);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_6                 <=  reg_data(18)(26 downto 24);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_7                 <=  reg_data(18)(30 downto 28);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_8                 <=  reg_data(19)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_9                 <=  reg_data(19)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_10                <=  reg_data(19)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_11                <=  reg_data(19)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_12                <=  reg_data(19)(18 downto 16);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_13                <=  reg_data(19)(22 downto 20);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_14                <=  reg_data(19)(26 downto 24);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_15                <=  reg_data(19)(30 downto 28);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_16                <=  reg_data(20)( 2 downto  0);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_17                <=  reg_data(20)( 6 downto  4);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_18                <=  reg_data(20)(10 downto  8);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_19                <=  reg_data(20)(14 downto 12);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_20                <=  reg_data(20)(18 downto 16);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_21                <=  reg_data(20)(22 downto 20);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_22                <=  reg_data(20)(26 downto 24);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_23                <=  reg_data(20)(30 downto 28);       
  Ctrl.LPGBT.UPLINK(1).ALIGN_24                <=  reg_data(21)( 2 downto  0);       
    ...
    if (rising_edge(clk)) then  -- rising clock edge
      ...
      if strobe_pulse='1' and wb_write = '1' then
        ...
        when 18 => --0x12
          ...
          reg_data(18)(18 downto 16)            <=  localWrData(18 downto 16);      --
          reg_data(18)(22 downto 20)            <=  localWrData(22 downto 20);      --
          reg_data(18)(26 downto 24)            <=  localWrData(26 downto 24);      --
          reg_data(18)(30 downto 28)            <=  localWrData(30 downto 28);      --
        when 19 => --0x13
          reg_data(19)( 2 downto  0)            <=  localWrData( 2 downto  0);      --
          reg_data(19)( 6 downto  4)            <=  localWrData( 6 downto  4);      --
          reg_data(19)(10 downto  8)            <=  localWrData(10 downto  8);      --
          reg_data(19)(14 downto 12)            <=  localWrData(14 downto 12);      --
          reg_data(19)(18 downto 16)            <=  localWrData(18 downto 16);      --
          reg_data(19)(22 downto 20)            <=  localWrData(22 downto 20);      --
          reg_data(19)(26 downto 24)            <=  localWrData(26 downto 24);      --
          reg_data(19)(30 downto 28)            <=  localWrData(30 downto 28);      --
        when 20 => --0x14
          reg_data(20)( 2 downto  0)            <=  localWrData( 2 downto  0);      --
          reg_data(20)( 6 downto  4)            <=  localWrData( 6 downto  4);      --
          reg_data(20)(10 downto  8)            <=  localWrData(10 downto  8);      --
          reg_data(20)(14 downto 12)            <=  localWrData(14 downto 12);      --
          reg_data(20)(18 downto 16)            <=  localWrData(18 downto 16);      --
          reg_data(20)(22 downto 20)            <=  localWrData(22 downto 20);      --
          reg_data(20)(26 downto 24)            <=  localWrData(26 downto 24);      --
          reg_data(20)(30 downto 28)            <=  localWrData(30 downto 28);      --
        when 21 => --0x15
          reg_data(21)( 2 downto  0)            <=  localWrData( 2 downto  0);      --
          reg_data(21)( 6 downto  4)            <=  localWrData( 6 downto  4);      --
          reg_data(21)(10 downto  8)            <=  localWrData(10 downto  8);      --
          reg_data(21)(14 downto 12)            <=  localWrData(14 downto 12);      --
        when 31 => --0x1f
      ...
      reg_data( 2)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_0;
      reg_data( 2)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_1;
      reg_data( 2)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_2;
      reg_data( 2)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_3;
      reg_data( 2)(18 downto 16)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_4;
      reg_data( 2)(22 downto 20)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_5;
      reg_data( 2)(26 downto 24)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_6;
      reg_data( 2)(30 downto 28)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_7;
      reg_data( 3)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_8;
      reg_data( 3)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_9;
      reg_data( 3)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_10;
      reg_data( 3)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_11;
      reg_data( 3)(18 downto 16)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_12;
      reg_data( 3)(22 downto 20)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_13;
      reg_data( 3)(26 downto 24)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_14;
      reg_data( 3)(30 downto 28)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_15;
      reg_data( 4)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_16;
      reg_data( 4)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_17;
      reg_data( 4)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_18;
      reg_data( 4)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_19;
      reg_data( 4)(18 downto 16)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_20;
      reg_data( 4)(22 downto 20)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_21;
      reg_data( 4)(26 downto 24)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_22;
      reg_data( 4)(30 downto 28)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_23;
      reg_data( 5)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_24;
      reg_data( 5)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_25;
      reg_data( 5)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_26;
      reg_data( 5)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(0).ALIGN_27;
      reg_data(16)( 0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).RESET;
      reg_data(18)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_0;
      reg_data(18)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_1;
      reg_data(18)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_2;
      reg_data(18)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_3;
      reg_data(18)(18 downto 16)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_4;
      reg_data(18)(22 downto 20)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_5;
      reg_data(18)(26 downto 24)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_6;
      reg_data(18)(30 downto 28)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_7;
      reg_data(19)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_8;
      reg_data(19)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_9;
      reg_data(19)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_10;
      reg_data(19)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_11;
      reg_data(19)(18 downto 16)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_12;
      reg_data(19)(22 downto 20)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_13;
      reg_data(19)(26 downto 24)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_14;
      reg_data(19)(30 downto 28)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_15;
      reg_data(20)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_16;
      reg_data(20)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_17;
      reg_data(20)(10 downto  8)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_18;
      reg_data(20)(14 downto 12)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_19;
      reg_data(20)(18 downto 16)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_20;
      reg_data(20)(22 downto 20)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_21;
      reg_data(20)(26 downto 24)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_22;
      reg_data(20)(30 downto 28)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_23;
      reg_data(21)( 2 downto  0)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_24;
      reg_data(21)( 6 downto  4)  <= DEFAULT_READOUT_BOARD_CTRL_t.LPGBT.UPLINK(1).ALIGN_25;
