...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    if rising_edge(clk) then  -- rising clock edge
      ...
      if wb_strobe='1' then
        ...
        when 19 => --0x13
          localRdData( 3 downto  0)  <=  reg_data(19)( 3 downto  0);                  --0=etroc, 1=upcnt, 2=prbs, 3=sw fast command, 4=fw fast command
        when 20 => --0x14
  ...
  begin  -- process reg_writes
    if (rising_edge(clk)) then  -- rising clock edge
      ...
      Ctrl.LPGBT.DAQ.DOWNLINK.L1A_PULSE <= '0';
      Ctrl.LPGBT.DAQ.DOWNLINK.LINK_RESET_PULSE <= '0';
      Ctrl.LPGBT.DAQ.DOWNLINK.L1A_RATE <= (others => '0');
      ...
      if strobe_pulse='1' and wb_write = '1' then
        ...
        when 19 => --0x13
          reg_data(19)( 3 downto  0)                <=  localWrData( 3 downto  0);      --0=etroc, 1=upcnt, 2=prbs, 3=sw fast command, 4=fw fast command
        when 20 => --0x14
        ...
        when 22 => --0x16
          Ctrl.LPGBT.DAQ.DOWNLINK.L1A_PULSE         <=  localWrData( 0);               
        when 23 => --0x17
          Ctrl.LPGBT.DAQ.DOWNLINK.LINK_RESET_PULSE  <=  localWrData( 0);               
        when 24 => --0x18
          Ctrl.LPGBT.DAQ.DOWNLINK.L1A_RATE          <=  localWrData(31 downto  0);     
        when 31 => --0x1f
