...
set_property PACKAGE_PIN AK17 [get_ports osc_clk300_p]
set_property PACKAGE_PIN AK16 [get_ports osc_clk300_n]

create_clock -period 8.000 -name osc_clk125 [get_ports osc_clk125_p]
set_property IOSTANDARD LVDS [get_ports osc_clk125_p]
set_property PACKAGE_PIN G10 [get_ports osc_clk125_p]
set_property PACKAGE_PIN F10 [get_ports osc_clk125_n]

set_property PACKAGE_PIN V6 [get_ports sma_refclk_p]
set_property PACKAGE_PIN V5 [get_ports sma_refclk_n]
...
set_property LOC {}  [get_cells -quiet -hierarchical -filter {BEL =~ *GTE3*}]
...
set_property PACKAGE_PIN T2 [get_ports {rx_p[0]}]
set_property PACKAGE_PIN U4 [get_ports {tx_p[0]}]
# set_property PACKAGE_PIN T1 [get_ports {rx_n[0]}]; # bank 226 -- X0Y10 -- GTH1
set_property PACKAGE_PIN V2 [get_ports {rx_p[1]}]
set_property PACKAGE_PIN W4 [get_ports {tx_p[1]}]
#
# bank 227
# pin assignments from ug917-kcu105-eval-bd.pdf

set_property PACKAGE_PIN E4 [get_ports {rx_p[2]}]
set_property PACKAGE_PIN F6 [get_ports {tx_p[2]}]
set_property PACKAGE_PIN D2 [get_ports {rx_p[3]}]
set_property PACKAGE_PIN D6 [get_ports {tx_p[3]}]
set_property PACKAGE_PIN B2 [get_ports {rx_p[4]}]
set_property PACKAGE_PIN C4 [get_ports {tx_p[4]}]
set_property PACKAGE_PIN A4 [get_ports {rx_p[5]}]
set_property PACKAGE_PIN B6 [get_ports {tx_p[5]}]
set_property PACKAGE_PIN M2 [get_ports {rx_p[6]}]
set_property PACKAGE_PIN N4 [get_ports {tx_p[6]}]
set_property PACKAGE_PIN K2 [get_ports {rx_p[8]}]
set_property PACKAGE_PIN L4 [get_ports {tx_p[8]}]
set_property PACKAGE_PIN H2 [get_ports {rx_p[7]}]
set_property PACKAGE_PIN J4 [get_ports {tx_p[7]}]
set_property PACKAGE_PIN F2 [get_ports {rx_p[9]}]
set_property PACKAGE_PIN G4 [get_ports {tx_p[9]}]
...
# refclks
set_property PACKAGE_PIN P5 [get_ports si570_refclk_n]
set_property PACKAGE_PIN P6 [get_ports si570_refclk_p]
...
create_clock -period 1.590 -name ethclk [get_ports sgmii_clk_p]
...
set_property PULLDOWN true [get_ports user_sma_n]
set_property PULLDOWN true [get_ports user_sma_p]
